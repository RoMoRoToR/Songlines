...
horizons, unregulated exchange is harmful, explicit cross-agent
temporal comparability (here, a world-clock) is necessary but
insufficient in the evaluated drift setting, and receiver-side
admission --- validating foreign testimony on the recipient's own
visit --- reverses the sign: mean cumulative cost falls below
independent memory on both roles (fragile $118$ vs.\ $148$, robust
$134$ vs.\ $171$; ${\approx}20\%$ relative). An integrated single runtime combines
...
cost. The result is an end-to-end research prototype of utility-gated,
...
world-clock necessary-but-insufficient in the evaluated drift setting 	o-side admission),
...
limitation rather than average it away.
...
\emph{systems comparison} of one consolidation pipeline against raw
context, not evidence of a fundamental long-context limitation; and
