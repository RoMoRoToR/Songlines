...
% DRAFT: лёгкий теорвклад = Definition 1/2 + identifiability;
% математическая новизна явно НЕ заявляется (non-claims box).
yes
...
yes
	...
	% DRAFT: assumption1_stress_test.py, theta_ablation.py,
% analyze_effect_sizes.py в code supplement.
yes
