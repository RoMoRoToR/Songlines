...
yes
	...
	% DRAFT: Assumption 1 (stage-Markov) сформулировано явно;
% coupling-каналы Definition 2 тоже.
yes
...
yes
	...
	% DRAFT: сознательный выбор effect sizes + cluster-robust CI
% ВМЕСТО p-values (обоснование в тексте); формальных парных
% тестов вида Wilcoxon нет.
partial
